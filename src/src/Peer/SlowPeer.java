 ...
 */
public class SlowPeer extends UnicastRemoteObject implements Peer
{
    ...
    public SlowPeer(String centralIp, int capacity) throws RemoteException {
        super();
    ...
    public static void main(String args[]) throws Exception {
        ...
        SlowPeer obj = new SlowPeer(centralIp, capacity);
